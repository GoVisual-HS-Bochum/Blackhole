...
import { TerminDialogComponent } from '../../../../../../main/webapp/app/entities/termin/termin-dialog.component';
...
import { RaumService } from '../../../../../../main/webapp/app/entities/raum';

describe('Component Tests', () => {

    describe('Termin Management Dialog Component', () => {
        let comp: TerminDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(TerminDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'terminListModification', content: 'OK'});
