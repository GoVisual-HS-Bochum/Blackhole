...
import com.govisual.blackhole.config.audit.AuditEventConverter;
import com.govisual.blackhole.domain.PersistentAuditEvent;
...
import static com.govisual.blackhole.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
