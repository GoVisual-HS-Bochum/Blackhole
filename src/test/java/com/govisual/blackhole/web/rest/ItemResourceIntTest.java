...
import com.govisual.blackhole.repository.ItemRepository;
...
public class ItemResourceIntTest {
    ...
    public void createItem() throws Exception {
        ...
        assertThat(testItem.getBezeichnung()).isEqualTo(DEFAULT_BEZEICHNUNG);
    }
    ...
    public void updateItem() throws Exception {
        ...
        Item testItem = itemList.get(itemList.size() - 1);
        assertThat(testItem.getBezeichnung()).isEqualTo(UPDATED_BEZEICHNUNG);
    }
