...
public class RaumResourceIntTest {
    ...
    public static Raum createEntity(EntityManager em) {
        Raum raum = new Raum()
            ...
            .art(DEFAULT_ART);
        // Add required entity
        PositionRaum posID = PositionRaumResourceIntTest.createEntity(em);
        em.persist(posID);
        em.flush();
        raum.setPosID(posID);
        // Add required entity
        Groesse groID = GroesseResourceIntTest.createEntity(em);
        em.persist(groID);
        em.flush();
        raum.setGroID(groID);
        return raum;
    ...
    public void createRaum() throws Exception {
        ...
        assertThat(testRaum.getArt()).isEqualTo(DEFAULT_ART);
    }
    ...
    public void updateRaum() throws Exception {
        ...
        assertThat(testRaum.getArt()).isEqualTo(UPDATED_ART);
    }
